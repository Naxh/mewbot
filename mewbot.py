...
async def help(ctx, val=None):
	if val is None:
		...
		embed.add_field(name="Ping", value="Pings the bot and shows it's latency", inline=True)
		embed.add_field(name="Mew", value="A simple Ping, just responds with Mew!", inline=True)
		embed.add_field(name="trainer", value="Displays your Trainer Card and other information", inline=True)
		embed.add_field(name="start", value="Start Playing Mewbot!!", inline=True)
		embed.add_field(name="trade", value="Trade Items, Redeems, Pokemon, and Credits!", inline=True)
		embed.add_field(name="shop", value="Buy TMs, Held Items, Evolution Items & More!", inline=True)
		embed.add_field(name="buy", value="`;buy <item_name>` to buy an item", inline=True)
		embed.add_field(name="reward", value="Get Upvote Rewards! NOTE: Only Use this command WHEN you have Upvoted!", inline=True)
		embed.add_field(name="upvote", value="Upvote the Bot for rewards!!", inline=True)
		embed.add_field(name="moves", value="See your current move count!", inline=True)
		embed.add_field(name="learn", value="Learn a Move! `;learn <move-name> <slot_number>", inline=True)
		embed.add_field(name="tms", value="Get the entire moveset of your pokemon!", inline=True)
		embed.add_field(name="pokemon", value="View your Pokemon List!", inline=True)
		embed.add_field(name="select", value="Select a Pokemon!", inline=True)
		embed.add_field(name="mega", value="`;help mega` to see information on Mega Evolution!!", inline=True)
		embed.add_field(name="donate", value="Donate to the bot! 1 USD = 2 Redeems + 50,000ℳ", inline=True)
		embed.add_field(name="vote", value="Upvote the Bot for Rewards!, 10 Upvote Points = 5 Redeems!", inline=True)
		embed.add_field(name="botinfo", value="User count, server count, CPU and Memory Status and More!", inline=True)

...
async def shop(ctx, val=None):
	...
	if val is None:
		...
		e.add_field(name="Reveal Glass", value="Buy this to Change the forms of the weather trio! | 7,500ℳ")
		e.add_field(name="Zygarde cell", value="Get Zygarde-complete by Buying 10 Zygarde Cells! | 15,000 ℳ")
		e.add_field(name="Gracidea flower", value="Buy the Gracidea flower to Evolve your Shaymin to Shaymin-sky! | 7,000ℳ")

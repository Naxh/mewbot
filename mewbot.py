...
async def shop(ctx, val=None):
	if val is None:
		...
		e.add_field(name="Mind Plate", value="Changes Arceus and Judgement to the psychic")
		e.add_field(name="Pixie Plate", value="Changes Arceus and Judgement to the fairy")
		e.add_field(name="Sky Plate", value="Changes Arceus and Judgement to the flying")
		e.add_field(name="Splash Plate", value="Changes Arceus and Judgement to the water")
		e.add_field(name="Spooky Plate", value="Changes Arceus and Judgement to the ghost")
		e.add_field(name="Stone Plate", value="Changes Arceus and Judgement to the rock")
		e.add_field(name="Toxic Plate", value="Changes Arceus and Judgement to the poison")
		e.add_field(name="Zap Plate", value="Changes Arceus and Judgement to the electric")
		e.set_footer(text="Please Be patient, the shop is currently being worked on")
		await ctx.send(embed=e)
@bot.command()
@commands.cooldown(1, 3, commands.BucketType.user)
